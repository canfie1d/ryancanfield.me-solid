...
export const ARTICLE_LINKS = [
  ...
  },
  {
    ...
    url:
      'https://medium.com/@Canfie1d/reactjs-and-embedded-svg-icons-1e6eed0dc16a',
    length: '4 min read',
  },
  {
    ...
    url:
      'https://medium.com/@Canfie1d/smacss-bem-edge-case-naming-convention-73be902b1d30',
    length: '3 min read',
  },
];
...
export const CASE_STUDIES = [
  {
    ...
    problem: {
      ...
      images: [
        {
          src:
            'https://s3-us-west-2.amazonaws.com/ryancanfield.me-images/FreightWeb/tmw_5.png',
          caption:
    ...
    solution: {
      ...
      images: [
        {
          src:
            'https://s3-us-west-2.amazonaws.com/ryancanfield.me-images/FreightWeb/shipment_dashboard_design.png',
        },
        {
          src:
            'https://s3-us-west-2.amazonaws.com/ryancanfield.me-images/FreightWeb/trip_list_wide.png',
        },
      ],
    },
    result: {
      ...
      images: [
        {
          src:
            'https://s3-us-west-2.amazonaws.com/ryancanfield.me-images/FreightWeb/auction_bids_2.png',
        },
      ],
    },
    additionalImages: [
      {
        src:
          'https://s3-us-west-2.amazonaws.com/ryancanfield.me-images/FreightWeb/add_shipment_1.png',
      },
      {
        src:
          'https://s3-us-west-2.amazonaws.com/ryancanfield.me-images/FreightWeb/add_auction.png',
      },
      {
        src:
          'https://s3-us-west-2.amazonaws.com/ryancanfield.me-images/FreightWeb/carrier_profile.png',
      },
      {
        src:
          'https://s3-us-west-2.amazonaws.com/ryancanfield.me-images/FreightWeb/driver_hub_trip.png',
      },
      {
        src:
          'https://s3-us-west-2.amazonaws.com/ryancanfield.me-images/FreightWeb/HelloFuel_DriverHub_Flow.png',
      },
    ],
    videoUrl:
  ...
  },
  {
    ...
    solution: {
      ...
      images: [
        {
          src:
            'https://s3-us-west-2.amazonaws.com/ryancanfield.me-images/Xinova/submit_2.png',
        },
      ],
    },
    result: {
      ...
      images: [
        {
          src:
            'https://s3-us-west-2.amazonaws.com/ryancanfield.me-images/Xinova/rfx.png',
        },
      ],
    },
    additionalImages: [
      {
        src:
          'https://s3-us-west-2.amazonaws.com/ryancanfield.me-images/Xinova/projects.png',
      },
      {
        src:
          'https://s3-us-west-2.amazonaws.com/ryancanfield.me-images/Xinova/solutions.png',
      },
    ],
    videoUrl:
