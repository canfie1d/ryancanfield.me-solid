        ...
        <div class={style['content__split']}>
          ...
          <AnimatedWaypoint> */}
            <div class={style['content__split__column']}>
              ...
              <p class='p'>Currently, I am an engineering manager at <a href='http://assembleinc.com' class='a'>Assemble</a>. In addition to leading an engineering team I am frequently relied on for architectural and technical estimations and vetting.</p>
            </div>
          {/* </AnimatedWaypoint> */}
        </div>
      </div>
